...
Учебный проект на базе React + TypeScript + Vite с использованием Redux Toolkit. Цель — показать организацию небольшой библиотеки (книги и авторы) и CRUD-операции.
